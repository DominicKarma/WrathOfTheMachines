...
namespace WoTM.Content.NPCs.ExoMechs
{
    public sealed partial class DraedonBehaviorOverride : NPCBehaviorOverride
    {
        ...
        /// </summary>
        public static readonly DraedonDialogueChain PostBattleInterjection = new DraedonDialogueChain("Mods.WoTM.NPCs.Draedon.").
        ...
        /// The monologue that Draedon uses upon the Exo Mechs battle concluding the first time you defeat them.
        /// </summary>
        public static readonly DraedonDialogueChain PostBattleAnalysisInterjection = new DraedonDialogueChain("Mods.WoTM.NPCs.Draedon.").
