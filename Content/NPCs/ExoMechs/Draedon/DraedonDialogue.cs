...
namespace DifferentExoMechs.Content.NPCs.ExoMechs
{
    ...
    public record DraedonDialogue(string LocalizationKey, Color TextColor, int SpeakTime, int SpeakDelay)
    {
        /// <summary>
        /// A neat shorthand for calling <see cref="Language.GetTextValue"/> on the <see cref="LocalizationKey"/>.
        /// </summary>
        public string Text => Language.GetTextValue(LocalizationKey);
