...
{
    public sealed partial class ArtemisBehavior : NPCBehaviorOverride, IExoMech, IExoTwin
    {
        ...
        public override void AI()
        {
            ...
            else if (CalamityGlobalNPC.draedonExoMechTwinGreen != -1 && Main.npc[CalamityGlobalNPC.draedonExoMechTwinGreen].type == ExoMechNPCIDs.ApolloID)
            {
                ...
                if (Main.npc[CalamityGlobalNPC.draedonExoMechTwinGreen].TryGetBehavior(out ApolloBehavior apollo))
