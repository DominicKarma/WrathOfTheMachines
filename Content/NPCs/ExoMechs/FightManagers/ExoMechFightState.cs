...
namespace WoTM.Content.NPCs.ExoMechs
{
    ...
    public record ExoMechFightState(DraedonBehaviorOverride.DraedonAIState? DraedonState, ExoMechState InitialMechState, params ExoMechState[] OtherMechsStates)
    {
        /// <summary>
        ...
        /// </summary>
        public static readonly ExoMechFightState UndefinedFightState = new(null, ExoMechState.UndefinedExoMechState);
    }
}
