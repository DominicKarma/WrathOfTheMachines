...
namespace WoTM.Content.NPCs.ExoMechs
{
    ...
    public record ExoMechFightState(DraedonBehaviorOverride.DraedonAIState? DraedonState, int TotalActiveMechs, ExoMechState InitialMechState, params ExoMechState[] OtherMechsStates)
    {
        /// <summary>
